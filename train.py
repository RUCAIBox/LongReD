...
def main(args):
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        max_position_embeddings = 130000
    )
    ...
    model_type = (
        "qwen2" if isinstance(model, transformers.Qwen2ForCausalLM) else model_type
    )
    ...
    for step, batch in enumerate(train_loader):
        ...
        with accelerator.accumulate(model):
            ...
            if accelerator.sync_gradients:
                ...
                print(completed_steps,gathered_loss)
...
if __name__ == "__main__":
    ...
    args.add_argument("--seq-length", type=int)
    args.add_argument(
        "--parallel_mode",
        type=str,
